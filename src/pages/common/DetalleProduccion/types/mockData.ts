import type {EstructuraProduccionDTO, RespuestasProduccionDTO} from './Productions';
    ...
    estructura: [
        {
            ...
            orden: 1,
            camposSimples: [
                {id: 101, idSeccion: 1, idGrupo: null, nombre: 'Proveedor', tipoDato: TipoDatoCampo.TEXTO, orden: 1},
                {
                    id: 102,
                    idSeccion: 1,
                    idGrupo: null,
            ...
            tablas: [
                {
                    ...
                    columnas: [
                        ...
                        {id: 313, idTabla: 301, nombre: 'Temperatura (°C)', orden: 3, tipoDato: TipoDatoCampo.NUMERICO},
                    ],
                    filas: [
...
export const mockRespuestas: RespuestasProduccionDTO = {
    produccion: {
    ...
    respuestasCampos: [
        {idRespuesta: 1, idCampo: 101, valor: 'Granja La Pradera', timestamp: '2024-07-21T08:05:10Z'},
    ...
    respuestasTablas: [
        ...
        },
        {
            ...
            tipoDatoColumna: TipoDatoCampo.NUMERICO,
            valor: '10',
            timestampRespuesta: '2024-07-21T08:15:00Z'
        },
        // Fila 2 parcial
