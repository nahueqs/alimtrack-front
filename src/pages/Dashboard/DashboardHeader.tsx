...
import { ThemeToggle } from '../../styles/shared/ThemeToggle.tsx';
import { MenuIcon, UserIcon } from '../../components/ui/Icons.tsx';
...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="dashboard__header">
      ...
      {showImages && (
        <div className="dashboard_nav__images">{/* Tus imágenes aquí si las necesitas */}</div>
      )}
    </header>
  );
};
