...
import type {VersionRecetaMetadataResponseDTO} from '@/pages/common/DetalleProduccion/types/Productions.ts'; // Changed import path and type
...
export const getColumns = ({
                           ...
                           }: GetColumnsProps): ColumnsType<VersionRecetaMetadataResponseDTO> => { // Changed type
    return [
        {
        ...
        },
        {
            ...
            render: (_: unknown, record: VersionRecetaMetadataResponseDTO) => ( // Changed type
