...
// Componente para la opción de versión en el dropdown
const VersionOption: React.FC<{ version: any }> = ({ version }) => (
  <div className="nueva-produccion-form__option-container">
    <div className="nueva-produccion-form__option-main">
      ...
      <span>{version.nombreVersion}</span>
    </div>
    {version.descripcion && (
  ...
  return (
    ...
    >
      ...
      >
          ...
          >
            {recipeVersions.map((version: any) => (
              <Select.Option
                ...
                label={`${version.codigoVersionReceta} - ${version.nombreVersion}`}
              >
              ...
              <div className="nueva-produccion-form__version-details-content">
                <div className="nueva-produccion-form__version-detail-row">
                  ...
                  <span className="nueva-produccion-form__version-detail-value">
                    {selectedVersion.codigoVersionReceta}
                  </span>
                </div>
                ...
                <div className="nueva-produccion-form__version-detail-row">
                  ...
                  <span className="nueva-produccion-form__version-detail-value">
                    {selectedVersion.nombreVersion}
                  </span>
                </div>

                {selectedVersion.descripcion && (
                  <div className="nueva-produccion-form__version-detail-row">
                    <span className="nueva-produccion-form__version-detail-label">
                      Descripción:
                    </span>
                    <span className="nueva-produccion-form__version-detail-value">
                      {selectedVersion.descripcion}
        ...
        <Form.Item
          label={<RequiredLabel>Número de Lote</RequiredLabel>}
          name="lote"
          rules={[
            {
              required: true,
        ...
        <Form.Item
          label={<RequiredLabel>Encargado de Producción</RequiredLabel>}
          name="encargado"
          rules={[
            {
              required: true,
