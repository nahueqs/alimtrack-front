...
import type { Production, ProductionsResponse, ProductionFilterRequestDTO } from '../types/Productions';
...
export const useProductions = (initialFilters: ProductionFilterRequestDTO = {}): UseProductionsReturn => {
